...
<section id="introduce">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="container">
            ...
            <p class="text-dark">Với 35 năm xây dựng và phát triển, 3C đã khẳng định được vị thế của mình trên thị trường cung cấp các sản phẩm, dịch vụ đã tham gia. Hiện nay, 3C đã trở thành một trong những nhà cung cấp hàng đầu các sản phẩm, dịch vụ công nghệ cao cho ngành Điện cao thế và Công nghệ thông tin.</p>
            <h4 class="mt-5 font-weight-bold">TẦM NHÌN</h4>
            <p class="mt-3 text-dark">3C phát triển nhanh, hiệu quả nhưng an toàn và bền vững, hướng đến mục tiêu tiếp tục trở thành một trong những Công ty hàng đầu Việt Nam trong lĩnh vực kinh doanh CNTT, Viễn thông, thiết bị thí nghiệm, duy trì vị thế số 1 về cung cấp Thiết bị điện 500KV.</p>
            <h4 class="mt-5 font-weight-bold">SỨ MỆNH</h4>
